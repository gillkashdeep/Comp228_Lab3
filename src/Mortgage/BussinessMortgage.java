...
public class BussinessMortgage extends MortgageClass {
    public BussinessMortgage(long mortgageNumber,String customerName,float amount,float rate,int term)
    {
        super(mortgageNumber,customerName,amount,1+rate,term);
    }

    public void getMortgageInfo(){
        System.out.println("Customer Information for Business Mortgage : ");
